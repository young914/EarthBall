        ...
        <div id="content">
            <div id="content1">
                <div id="content1_1">
                    ...
                    <div id="content1_1_2">
                        <div id="img-area">
                            <div id="product_img"><img src="/resources/img/best1.png" width="100%" height="100%" alt="상품이미지"></div>
                        </div>
                ...
                <div id="content1_3">
                    ...
                    <div id="content1_3_2">
                        <table>
                            ...
                            <tr>
                                <td colspan="2">
                                    <input type="number" id="postCode" placeholder="우편번호" value="01716" width="50%" required>
