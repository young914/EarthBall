...
<div id="container">
    ...
    <div id="outer1">
        <div id="a">
            <div class="b">
                <input type="text" id="id" style="width : 74px;" placeholder="OOOO" maxlength="4" required>년
                <input type="text" id="id" style="width : 38px;" maxlength="2" placeholder="OO" required>월

                <input type="text" id="id" style="width : 38px;" maxlength="2" placeholder="OO" required>일
                <input type="text" id="id" style="width : 25px;" maxlength="1" placeholder="O" required>요일
            </div>
            <div id="c">
                <div class="icon">
                    <div id="c_1">
                    ...
                    <div id="c_4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="40px" fill="currentColor"
                             class="bi bi-snow" id="w" viewBox="0 0 16 16">
        ...
        <div class="controls">
            ...
            <div class="controls_btns">
                ...
                <button onclick="" id="jsSave">그림완료</button>
            </div>
    ...
    <div class="outer2">
        <div class="title">제목: <input type="text"></div>
        <div class="content"><textarea name="" id=""></textarea></div>
    </div>

    <div class="submit_btn1">
        <button onclick="WriteBtn();">글등록</button>
    </div>

</div>

<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/member/diary/diary.js"></script>
