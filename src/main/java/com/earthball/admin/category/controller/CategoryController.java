package com.earthball.admin.category.controller;
...
public class CategoryController {
    ...
    public String selectListCategory(Model model) {
        ...
        return "admin/category/categoryListView";
    }


    @GetMapping("EnrollForm.ca")
    public String insertCategoryForm() {
        return "admin/category/categoryEnrollForm";
    }
    ...
    public String categoryDetailView(int categoryNo, Model model) {
        ...
        return "admin/category/categoryDetailView";
    }
}
